...
function Shell({ mode }: ShellProps) {
  ...
  function handleCloseMovie() {
    // return to search, preserving q/page
    const qs = new URLSearchParams(searchParams);
    navigate(`/search?${qs.toString()}`);

    // move focus to avoid aria-hidden warning
